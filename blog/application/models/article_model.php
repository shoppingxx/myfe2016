...
class Article_model extends CI_Model
{
    ...
    public function save_types($types,$user_id){
    ...
    public function update_type($type_id,$type_name){
        //update  t_article_type set type_name $type_name where type_id=$type_id
    ...
    public function delete_article_type($type_id){
