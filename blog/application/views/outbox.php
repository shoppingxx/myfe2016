...
<ul>
	<?php foreach($results as $result){?>
   	  <li id="msg_186774">
		<span class="sender"><a href="#" target="user"><img src="images/portrait.gif" alt="" title="mytesting" class="SmallPortrait" user="154741" align="absmiddle"></a></span>
		<span class="msg">
			<div class="outline">
			...
			<div class="content"><div class="c"><?php echo $result->content;?></div></div>
		</span>
		<div class="clear"></div>
	  </li>
	<?php }?>
