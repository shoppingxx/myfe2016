...
class Welcome extends CI_Controller {
	...
	public function update_setting(){
		...
		if($row){
			...
			redirect('welcome/user_setting');
		}
	}
	public function profile(){
		$this->load->view('profile');

		//$this->welcome_model->update_profile($user);
	}
	public function update_profile(){
		...
		$row = $this->user_model->update_profile($username,$gender,$province,$city,$birthday,$content);
		if($row){
			...
			$this->set_session->userdata('logingedUser',$user);
